...
<main id="innerpage-box">
    <div class="container">
        <div class="inner_contentbox">
            <div class="row mr-0">
            <div id="blog-box" class="ht-blog-wrap innerpage-whitebox col-lg-8 col-md-8">
                <div class="row mr-0">
          <?php
                ...
                if($query -> have_posts()):
                    while($query -> have_posts()) : $query -> the_post();
                     ...
                     ?>
                    <div class="inner-blog-post col-lg-6 col-md-6 col-sm-12 col-xs-12 ">
                        <?php 
                        ...
                        <script type="text/javascript">
                            var title = 0;
                            jQuery(".page-template-blog-right-sidebar .inner-blogpost").each(function(){
                              if ($(this).height() > title) { title = $(this).height(); }
                            });
                            jQuery(".page-template-blog-right-sidebar .inner-blogpost").height(title);


                            // on Resize change height

                            jQuery(window).resize(function(){
                              jQuery(".page-template-blog-right-sidebar .inner-blogpost").height("");
                              var title = 0;
                              jQuery(".page-template-blog-right-sidebar .inner-blogpost").each(function(){
                                if ($(this).height() > title) { title = $(this).height(); }
                              });
