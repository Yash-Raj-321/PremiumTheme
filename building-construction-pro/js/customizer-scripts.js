jQuery(document).ready(function($) {
    ...
    // Pricing
    $('body').on('change', 'li#customize-control-ruh_pricing_npp_count select', function(){
        // alert($(this).val());
        ...
        for(var i=1;i<=4;i++){
            if(i <= len){
                // alert(i +'<= '+len);
                $('li#customize-control-ruh_pricing_plan_heading_'+i).show();
                $('li#customize-control-ruh_pricing_plan_name_'+i).show();
                $('li#customize-control-ruh_pricing_plan_price_'+i).show();
                $('li#customize-control-ruh_pricing_plan_content_'+i).show();
                $('li#customize-control-ruh_pricing_plan_page_'+i).show();
            }else{
                $('li#customize-control-ruh_pricing_plan_heading_'+i).hide();
                $('li#customize-control-ruh_pricing_plan_name_'+i).hide();
                $('li#customize-control-ruh_pricing_plan_price_'+i).hide();
                $('li#customize-control-ruh_pricing_plan_content_'+i).hide();
                $('li#customize-control-ruh_pricing_plan_page_'+i).hide();
            }
        }
    });

    // team
    $('body').on('change', 'li#customize-control-ruh_team_npp_count select', function(){
        // alert($(this).val());
        //hide the fields after the number
        var len = parseInt($(this).val())+1;
        for(var i=1;i<=4;i++){
            if(i <= len){
                // alert(i +'<= '+len);
                $('li#customize-control-ruh_team_heading'+i).show();
                $('li#customize-control-ruh_team_page'+i).show();
                $('li#customize-control-ruh_team_designation'+i).show();
                $('li#customize-control-ruh_team_facebook'+i).show();
                $('li#customize-control-ruh_team_twitter'+i).show();
                $('li#customize-control-ruh_team_google_plus'+i).show();
            }else{
                $('li#customize-control-ruh_team_heading'+i).hide();
                $('li#customize-control-ruh_team_page'+i).hide();
                $('li#customize-control-ruh_team_designation'+i).hide();
                $('li#customize-control-ruh_team_facebook'+i).hide();
                $('li#customize-control-ruh_team_twitter'+i).hide();
                $('li#customize-control-ruh_team_google_plus'+i).hide();
            }
        }
    });

    // featured
    $('body').on('change', 'li#customize-control-ruh_featured_npp_count select', function(){
        // alert($(this).val());
        //hide the fields after the number
        var len = parseInt($(this).val())+1;
        for(var i=1;i<=4;i++){
            if(i <= len){
                // alert(i +'<= '+len);
                $('li#customize-control-ruh_featured_header'+i).show();
                $('li#customize-control-ruh_featured_page'+i).show();
                $('li#customize-control-ruh_featured_page_icon'+i).show();
            }else{
                $('li#customize-control-ruh_featured_header'+i).hide();
                $('li#customize-control-ruh_featured_page'+i).hide();
                $('li#customize-control-ruh_featured_page_icon'+i).hide();
            }
        }
    });
