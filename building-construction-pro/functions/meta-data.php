...
function lzAddColorOrImagePanel($post) {
	...
	<div id="" class="inside">
		...
		<label class="post-attributes-label" for="useBgColor"> Use color as a BGS</label>
	</div>

	<div id="colorForBg" class="inside">
		<p><?php __('Choosse a color for your post backbround.', 'Ruh Premium' ); ?></p>
	...
	<div id="imageForBg" class="inside">
		...
		<label class="post-attributes-label" for="useBgImg"> Use Image as a BG</label>
	</div>
	<script>
		...
		jQuery(document).ready(function($) {
			...
			$.fn.upload_listing_image = function( button ) {
				...
				file_frame.on( 'select', function() {
				  ...
				  $("#ruh-page-color-palet img").attr('src',attachment.url);
				  $( '#ruh-page-color-palet img' ).show();
			...
			$('#ruh-page-color-palet').on( 'click', '#upload_listing_image_button', function( event ) {
				event.preventDefault();
				$.fn.upload_listing_image( $(this) );
			});
			$('#ruh-page-color-palet').on( 'click', '#remove_listing_image_button', function( event ) {
				event.preventDefault();
				$( '#upload_listing_image' ).val( '' );
				$( '#ruh-page-color-palet img' ).attr( 'src', '' );
				$( '#ruh-page-color-palet img' ).hide();
...
function lzInitMetaBoxesForAdmin(){
	add_meta_box('ruh-page-color-palet', __('Select Page BG Color', 'Ruh Premium'), 'lzAddColorOrImagePanel', 'page', 'side', 'default', null);
	add_meta_box('ruh-page-color-palet', __('Select Page BG Color', 'Ruh Premium'), 'lzAddColorOrImagePanel', 'post', 'side', 'default', null);
}
